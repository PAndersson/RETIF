...
classdef RT_Collector_nifti < RT_Collector
    ...
    properties
        ...
        nametemplate = '$$$.nii'; %template for name of nifti files.
    ...
    methods
        %Constructor
        function C = RT_Collector_nifti(input)
            ...
            C.check_timer = timer('StartDelay', 0,'Period', 0.1,'TasksToExecute', 50000,...
                'ExecutionMode','fixedRate','TimerFcn',{@RT_Collector_nifti.receiver,C});
        end
        ...
        function send(C,filename)
            ...
            newdata = load_untouch_nii([C.dumpdirectory,filename]);
    ...
    methods (Static)
        function receiver(tmr,tmrfnc,C)
            ...
            if C.force_order
                ...
                files = dir([C.dumpdirectory,C.nametemplate,nr,'.nii']);
                ...
                files = dir([C.dumpdirectory,C.nametemplate,'*.nii']);
