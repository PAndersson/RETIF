classdef RT_Application_SoundFreq < RT_Application
    ...
    methods
        ...
        %Constructor
        function C = RT_Application_SoundFreq(varargin) %screennr)
            ...
            temp = fileparts(which('RT_Application_SoundFreq'));
            [C.instr1, C.fsinstr] = wavread([temp '\Up.wav']);
            [C.instr2, C.fsinstr] = wavread([temp '\Down.wav']);
