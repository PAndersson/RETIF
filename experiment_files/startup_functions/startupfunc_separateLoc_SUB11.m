function GUI = startupfunc_separateLoc_SUB11(GUI)
      ...
      % files and folders
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      epi_folder = 'C:\Dropbox\Work\CIMeC\Data\ImagineFaceHouse\SUB11_19900610DLKZ_201411271050\LNiF_Schwarzbach_Jens_RTFmriiMAG\10_lnif_epi_3x3x3_dc_rt_fs_L_DiCo\';
      ROI_file1 = 'C:\Dropbox\Work\CIMeC\Analysis\ImagineFaceHouse\SUB11_19900610DLKZ_201411271050\10_LocImag\F-H__max100LT5.nii';
      ROI_file2 = 'C:\Dropbox\Work\CIMeC\Analysis\ImagineFaceHouse\SUB11_19900610DLKZ_201411271050\10_LocImag\H-F__max100LT5.nii';
      instruction = 'C:\Dropbox\Work\CIMeC\Analysis\ImagineFaceHouse\SUB11_19900610DLKZ_201411271050\instr_ImagFH_LocImag-11-001.txt';
      
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      % create brainmask from first image
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      temp = 'C:\Dropbox\Work\CIMeC\Data\ImagineFaceHouse\SUB11_19900610DLKZ_201411271050\LNiF_Schwarzbach_Jens_RTFmriiMAG\6_lnif_epi_3x3x3_dc_rt_fs_L_DiCo\';
