function GUI = startupfunc_separateLoc_SUB04(GUI)
      ...
      % files and folders
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      epi_folder = 'C:\Dropbox\Work\CIMeC\Data\ImagineFaceHouse\SUB04_19740731IESE_201410281300\LNiF_Schwarzbach_Jens_RTFmriiMAG\10_lnif_epi_3x3x3_dc_rt_fs_L_DiCo\';
      ROI_file1 = 'C:\Dropbox\Work\CIMeC\Analysis\ImagineFaceHouse\SUB04_19740731IESE_201410281300\10_LocImag_001\F-H__max100LT5.nii';
      ROI_file2 = 'C:\Dropbox\Work\CIMeC\Analysis\ImagineFaceHouse\SUB04_19740731IESE_201410281300\10_LocImag_001\H-F__max100LT5.nii';
      instruction = 'C:\Dropbox\Work\CIMeC\Analysis\ImagineFaceHouse\SUB04_19740731IESE_201410281300\instr_ImagFH_LocImag-04-001.txt';
      
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      % create brainmask from first image
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      temp = 'C:\Dropbox\Work\CIMeC\Data\ImagineFaceHouse\SUB04_19740731IESE_201410281300\LNiF_Schwarzbach_Jens_RTFmriiMAG\6_lnif_epi_3x3x3_dc_rt_fs_L_DiCo\';
